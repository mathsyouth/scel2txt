...
def single_file():
    input_path = 'sogou_dict/scel/XXXX.scel'    # 输入scel所在文件夹路径
    output_path = 'sogou_dict/txt/XXXX.txt'     # 输出txt所在文件夹路径
    # 转换scel为txt
    scel2txt(input_path)
    # 保存结果
...
def batch_file():
    input_dir = "sogou_dict/scel/"  # 批量输入文件的目录
    output_dir = "sogou_dict/txt/"  # 批量输出文件的目录
    # 遍历文件夹下的文件
